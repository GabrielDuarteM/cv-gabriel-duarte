  ...
  render () {
    ...
    const contatos = [
      ...
      },
      {
        ...
        contatos: [
          ...
          { titulo: '/GabrielDuarteM', faIcon: 'fa-linkedin-square', link: 'https://www.linkedin.com/in/GabrielDuarteM/' }
        ]
      }
    ]
    ...
    return (
      <div>
        ...
        {
          data.map((e, i) => <ExperienciaList key={i} titulo={intl.formatMessage({ id: e.id })} experiencias={e.experiencias} />)
        }
      </div>
    )
  }
